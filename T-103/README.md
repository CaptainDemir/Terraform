# Project-T103 : Phonebook Application (Python Flask) deployed on AWS Application Load Balancer with Auto Scaling and Relational Database Service using Terraform
...
|
|----readme.md               # Given to the DevOps Teams (Definition of the project)
|----main.tf                 # To be delivered by DevOps Teams (Terraform Configuration) 
|----phonebook-app.py        # Given to the DevOps Teams (Python Flask Web Application)
|----templates
        |----index.html      # Given to the DevOps Teams (HTML template)
        |----add-update.html # Given to the DevOps Teams (HTML template)
        |----delete.html     # Given to the DevOps Teams (HTML template)
```
...
### At the end of the project, DevOps Teams will be able to;
